...
chart6ID = 'chart6_ID', chart6_type = 'column', chart6_height = 300):
  ...
  data = pd.read_csv("D:\\FLASK_NEW\\EXample\\Data.csv")
  ...
  series5 = [{"name": 'Technologies', "data": values}]
  title5 = {"text": 'Distribution of Technologies'}
  ...
  series6 = [{"name": 'Technologies', "data": values}]
  title6 = {"text": 'Company vs Technologies'}
  xAxis6 = {"categories": company}
  yAxis6 = {"title": {"text": 'Count'}}

  return render_template('exm.html', chart1ID=chart1ID, chart1=chart1, series1=series1, title1=title1, xAxis1=xAxis1, yAxis1=yAxis1,
